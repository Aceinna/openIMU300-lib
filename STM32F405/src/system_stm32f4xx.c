/**
  ...
  *-----------------------------------------------------------------------------
  *        SYSCLK(Hz)                             | 119895666.666666
  *-----------------------------------------------------------------------------
  *        HCLK(Hz)                               | 119895666.666666
  *-----------------------------------------------------------------------------
  *        AHB Prescaler                          | 1
  *-----------------------------------------------------------------------------
  *        APB1 Prescaler                         | 4
...
/* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */
    ...
    // 24.806 MHz oscillator (-12 and later builds)
#define PLL_M      24
#define PLL_N      232
...
//#define PLL_M      12          // #1
//#define PLL_N      145
//uint32_t SystemCoreClock = 149869583;


//#define PLL_M      12          // #3
//#define PLL_N      155
//uint32_t SystemCoreClock = 160205416;


//#define PLL_M      12
//#define PLL_N      150      // #4
//uint32_t SystemCoreClock = 155037500;
...
/**
  ...
  * @retval None
  */
int SystemCoreClockUpdate(void)
{
  uint32_t tmp = 0, pllvco = 0, pllp = 2, pllsource = 0, pllm = 2;
  uint8_t intExtOscFlag = 0;
  ...
  switch (tmp)
  {
    ...
    case 0x08:  /* PLL used as system clock source */
      ...
      // If the external oscillator fails to drive the PLL then use the internal oscillator
      if (pllsource != 0)
      {
...
/******************************************************************************/
  ...
  /* Wait until HSE is ready or Time-Out is reached */
  do
  {
  ...
  { /* If HSE fails to start-up, the application will have wrong clock
    ...
    /* Configure the main PLL */
    RCC->PLLCFGR = 16 | (240 << 6) | (((PLL_P >> 1) -1) << 16) |
